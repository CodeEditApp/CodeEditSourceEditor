...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/lukepistrol/tree-sitter-c.git", branch: "feature/spm"),
        ...
        .package(url: "https://github.com/lukepistrol/tree-sitter-javascript.git", branch: "feature/spm"),
        .package(url: "https://github.com/mattmassicotte/tree-sitter-json.git", branch: "feature/spm"),
        .package(url: "https://github.com/lukepistrol/tree-sitter-php.git", branch: "feature/spm"),
        ...
        .package(url: "https://github.com/lukepistrol/tree-sitter-rust.git", branch: "feature/spm"),
